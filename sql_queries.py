...
song_table_create = ("CREATE TABLE IF NOT EXISTS songs (song_id varchar PRIMARY KEY," + 
                     " title varchar, artist_id varchar NOT NULL, year int, duration " +
...
songplay_table_create = ("CREATE TABLE IF NOT EXISTS songplays (songplay_id SERIAL " +
                         "PRIMARY KEY, start_time timestamp, user_id int NOT NULL, " +
                         "level varchar, song_id varchar, artist_id varchar, session_id" +
                         " int, location varchar, user_agent varchar, FOREIGN KEY(user_id)" +
...
song_select = ("select b.song_id, a.artist_id " + 
               "from songs b, artists a "+
               "where b.title=%s and a.name=%s and "+
               "b.duration=%s and b.artist_id=a.artist_id")
...
drop_table_queries = [songplay_table_drop, song_table_drop, 
                      user_table_drop, artist_table_drop, time_table_drop]